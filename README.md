...
| `conversation.md` | Full conversation with model responses |
...
The repository includes the original interaction data in `openrouter_interaction.json` and an English reference version in `conversation.md`.
